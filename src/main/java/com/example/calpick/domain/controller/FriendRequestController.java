...
public class FriendRequestController {
    ...
    public Response<Object> requestFriendRequest(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestBody SaveFriendRequestDto dto) throws Exception { //친구 요청
    ...
    @PutMapping("/requests")
    public Response<Object> responseFriendRequest(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestBody ResponseFriendRequestDto dto) throws Exception { //친구 요청 수락/거절
